...
// Function to fetch paid facilities from the database
function fetchFasilitasBerbayar($conn)
{
    $sql = "SELECT f.id, f.nama, f.objekWisataId, f.foto, f.jenisFasilitas, o.nama AS objekWisataNama 
            ...
            WHERE LOWER(f.jenisFasilitas) = 'berbayar'";
...
// Fetch the fasilitas berbayar data
$fasilitas = fetchFasilitasBerbayar($conn);
?>
...
<head>
    ...
    <title>Fasilitas Berbayar</title>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row justify-content-center">
                    <h2 class="text-center">Fasilitas Wisata Berbayar</h2>
                </div>
                <div class="row">
                    <?php foreach ($fasilitas as $f): ?>
                        <div class="col-md-4 mb-4 d-flex align-items-stretch">
                            <div class="fasilitas-card berbayar">
