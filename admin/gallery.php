    ...
    <div class="container content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3">
                    <a href="galleryAdd.php" class="btn btn-primary">Tambah Data</a>
                </div>
                ...
                <table class="table table-bordered" id="table-1">
                    ...
                    <tbody>
                        <!-- Start Tag PHP -->
                        <?php
                        // Start fetch gallery from database
                        function fetchGalleryFromDatabase()
                        {
                        ...
                        // End fetch gallery from database
                        $no = 0;
                        $gallery = fetchGalleryFromDatabase();
                        ...
                        foreach ($gallery as $g) {
                            ...
                            echo "<td>{$no}</td>";
                            echo "<td>{$g['nama']}</td>";
                            echo "<td><img src='{$g['foto']}' width='50px'></td>";
                            echo "<td>
                                <a href='galleryEdit.php?id={$g['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                <a href='galleryDel.php?id={$g['id']}' class='btn btn-danger btn-sm'>Delete</a>
                              </td>";
                            echo "</tr>";
                        }
                        // End perulangan data
