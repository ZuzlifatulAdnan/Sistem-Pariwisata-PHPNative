    ...
    <div class="container content">
        ...
        <form action="pemesananAddProses.php" method="post">
            ...
            <div class="form-group">
                ...
                <input id="inputAlamat" class="form-control" type="text" name="alamat" placeholder="Alamat" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="inputJumlahPaket" class="form-control" type="number" name="jumlahPeserta" onchange="calculateTotal()" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="inputNo" class="form-control" type="number" name="noTelephone" placeholder="No Telephone" required>
            </div>
            
            <div class="form-group">
                <label for="inputTotal">Total Harga</label>
                <input id="inputTotal" class="form-control" type="number" name="totalHarga" placeholder="Total Harga" required readonly>
            </div>
