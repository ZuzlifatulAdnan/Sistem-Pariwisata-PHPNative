...
<body>
    ...
    <div class="container content">
        ...
        <!-- Start form -->
        <form action="artikelAddProses.php" method="post" enctype="multipart/form-data">
            <!-- Start Input judul -->
            <div class="form-group">
                <label for="inputNama">Judul</label>
                <input id="inputNama" class="form-control" type="text" name="judul" placeholder="Judul" required>
            </div>
            <!-- End input judul -->
