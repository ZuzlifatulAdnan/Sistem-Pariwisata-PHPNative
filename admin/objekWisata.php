    ...
    <div class="container content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3">
                    <a href="objekWisataAdd.php" class="btn btn-primary">Tambah Data</a>
                </div>
                ...
                <table class="table table-bordered" id="table-1">
                    ...
                    <tbody>
                        ...
                        function fetchObjekWisataFromDatabase()
                        {
                            global $conn; // Access the database connection variable
                        
                            $sql = "SELECT id, nama, foto, tglUpload FROM objekwisata";
                        ...
                        $no = 0;
                        $objeks = fetchObjekWisataFromDatabase();
                        ...
                        foreach ($objeks as $o) {
                            ...
                            echo "<td>{$no}</td>";
                            echo "<td>{$o['nama']}</td>";
                            echo "<td><img src='{$o['foto']}' width='50px'></td>";
                            echo "<td>{$o['tglUpload']}</td>";
                            echo "<td>
                                <a href='objekWisataDetail.php?id={$o['id']}' class='btn btn-info btn-sm'>Detail</a>
                                <a href='objekWisataEdit.php?id={$o['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                <a href='objekWisataDel.php?id={$o['id']}' class='btn btn-danger btn-sm'>Delete</a>
                              </td>";
                            echo "</tr>";
                        }
                        // End perulangan data
