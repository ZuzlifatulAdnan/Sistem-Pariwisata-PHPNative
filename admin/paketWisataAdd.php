...
<body>
    ...
    <div class="container content">
        <!-- Start Judul Halaman Tambah paket wisata -->
        <div class="row justify-content-center">
            <h2 class="text-center">Tambah Paket Wisata</h2>
        </div>
        <!-- End Judul Halaman Tambah paket wisata -->
        <!-- Start form -->
        <form action="paketWisataAddProses.php" method="post">
            <!-- Start Input nama -->
            ...
            <div class="form-group">
                ...
                <input id="inputHarga" class="form-control" type="text" name="harga" placeholder="Harga" required>
            </div>
            <!-- End input harga -->
            <!-- start tombol  -->
