    ...
    <div class="container content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3">
                    <a href="paketWisataAdd.php" class="btn btn-primary">Tambah Data</a>
                </div>
                ...
                <table class="table table-bordered" id="table-1">
                    ...
                    <tbody>
                        <!-- Start Tag PHP -->
                        <?php
                        // Start fetch paket from database
                        function fetchPaketWisataFromDatabase()
                        {
                        ...
                        // End fetch paket wisatafrom database
                        $no = 0;
                        $paket = fetchPaketWisataFromDatabase();
                        ...
                        foreach ($paket as $p) {
                            ...
                            echo "<td>{$no}</td>";
                            echo "<td>{$p['nama']}</td>";
                            echo "<td>Rp.{$p['harga']}</td>";
                            echo "<td>
                                <a href='paketWisataEdit.php?id={$p['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                <a href='paketWisataDel.php?id={$p['id']}' class='btn btn-danger btn-sm'>Delete</a>
                              </td>";
                            echo "</tr>";
                        }
                        // End perulangan data
