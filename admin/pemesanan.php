    ...
    <div class="container content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3">
                    <a href="pemesananAdd.php" class="btn btn-primary">Tambah Data</a>
                </div>
                ...
                <table class="table table-bordered" id="table-1">
                    ...
                    <tbody>
                        ...
                        function fetchPemesananFromDatabase()
                        {
                            global $conn; // Access the database connection variable
                        
                            $sql = "SELECT p.id, p.noPemesanan, p.nama, o.nama AS objekwisata
                            FROM pemesanan p
                        ...
                        $no = 0;
                        $pesan = fetchPemesananFromDatabase();
                        // Start perulangan data
                        foreach ($pesan as $p) {
                            $no++;
                            echo "<tr>";
                            echo "<td>{$no}</td>";
                            echo "<td>{$p['noPemesanan']}</td>";
                            echo "<td>{$p['nama']}</td>";
                            echo "<td>{$p['objekwisata']}</td>";
                            echo "<td>
                                <a href='pemesananCetakPDF.php?id={$p['id']}' class='btn btn-primary btn-sm'>Cetak</a>    
                                <a href='pemesananDetail.php?id={$p['id']}' class='btn btn-info btn-sm'>Detail</a>
                                <a href='pemesananEdit.php?id={$p['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                <a href='pemesananDel.php?id={$p['id']}' class='btn btn-danger btn-sm'>Delete</a>
                              </td>";
                            echo "</tr>";
                        }
                        // End perulangan data
